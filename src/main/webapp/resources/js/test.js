...
console.log("Supported Constraints by Browser:");
console.log(navigator.mediaDevices.getSupportedConstraints());
navigator.mediaDevices.getUserMedia(videoConstraints)
    .then(function(stream){
        for(const track of stream.getTracks()){
            console.log("Supported Constraints by the Device:");
            console.log(track);
...
////////////////////////////////////////////////////////
function initSocket(){
  const socket = new WebSocket('wss://363ef260.ngrok.io/video-conference/signaling');
